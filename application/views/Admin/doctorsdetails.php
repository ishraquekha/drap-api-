...
<div class="container bootstrap snippet">
    ...
    <div class="row">
      ...
      <div class="text-center">
        ...
        <input type="file" name="image" class="text-center center-block file-upload" accept="image/jpeg,image/png,image/jpg">
      </div>
      <br>
            ...
            <div class="tab-pane active" id="home">
                <hr>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              <label for="email"><h4>Speciality</h4></label>
                              <select name="speciality" >
                                    <option selected class="form-control" value="<?php echo $data['spacialistid'];?>"><?php echo $data['spacialist'];?></option> 
                                    <?php foreach($list as $l):?>
                                    <option class="form-control" value="<?php echo $l['id'];?>"><?php echo $l['spacialist'];?></option> 
                                    <?php endforeach; ?>
                            </select>
                  ...
                  <!-- <form class="form" action="<?php echo base_url()?>index.php/updatedoctor" method="post" id="registrationForm"> -->
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <a class="form-control" href="<?php echo $data['identitydocument'];?>" title="<?php echo $data['firstname'].'-identity document';?>"><?php echo $data['firstname'].'-identity document';?></a>
                          </div>
                      </div>
                      <div class="form-group">
                          
                          <div class="col-xs-6">
                            <label for="last_name"><h4>Eunacom</h4></label>
                            <a class="form-control" href="<?php echo $data['eunacom'];?>" title="<?php echo $data['firstname'].'-post graduate document';?>"><?php echo $data['firstname'].'-Eunacom';?></a>                     
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <a class="form-control" href="<?php echo $data['legaldocument'];?>" title="<?php echo $data['firstname'].'-legal document';?>"><?php echo $data['firstname'].'-legal document';?></a>                       
                            </div>
                      </div>
