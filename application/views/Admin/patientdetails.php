             ...
             <div class="tab-pane" id="settings">
                  ...
                  <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input  disabled type="text" class="form-control" name="medicalhistory" id="medicalhistory" placeholder="medical history" value="<?php echo $medical['medicalhistory'];?>" title="enter your medical history.">
                            </div>
                      </div>
                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
                             ...
                             <input   disabled type="text" class="form-control" name="surgeries" id="surgeries" placeholder="surgeries" value="<?php echo $medical['surgeries'];?>" title="enter your experience.">
                            </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input  disabled type="text" class="form-control" name="allergictomedications" id="consultationrateunit" placeholder="allergic to medications" value="<?php echo $medical['allergictomedications'];?>" title="enter your allergic to medication.">
                          </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                            ...
                            <input  disabled type="text" class="form-control" name="familybackground" id="familybackground" placeholder=" family background" value="<?php echo $medical['familybackground'];?>" title="enter your Family Background.">
                        </div>
                      </div>
                    <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              <label for="email"><h4>Is Allergic to Medications</h4></label>
                                <p><?php if($medical['isallergictomedications']==0){
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              <label for="phone"><h4>Is Pregnant</h4></label>
                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
                             <label for="mobile"><h4>Pregnancy Details</h4></label>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              <label for="phone"><h4>Is Birth</h4></label>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              <label for="phone"><h4>Is Abortion</h4></label>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              <label for="phone"><h4>Is Contraceptives</h4></label>
                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
                             <label for="mobile"><h4>Last Menstruation Date</h4></label>
